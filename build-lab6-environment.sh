...
HOSTS["control"]="52:54:00:5d:e1:42"
HOSTS["ansible1"]="52:54:00:5d:e1:43"
HOSTS["ansible2"]="52:54:00:5d:e1:44"
HOSTS["ansible3"]="52:54:00:5d:e1:45"
HOSTS["ansible4"]="52:54:00:5d:e1:46"
VM_W_EXTRA_DISK=(ansible1 ansible3)
EXTRA_DISK_SIZE="5G"
VM_W_DVD_IMG=(control)
PREFIX="lab6"
...
echo '10.9.0.42' > inventory
ansible 10.9.0.42 -i inventory -u root -e ansible_password=password -m wait_for_connection 
ansible 10.9.0.42 -i inventory -u root -e ansible_password=password -m user -a 'name=ansible state=present'
ansible 10.9.0.42 -i inventory -u root -e ansible_password=password -m copy -a 'dest=/etc/sudoers.d/ansible content="ansible ALL=(ALL) NOPASSWD: ALL"'
deactivate
rm inventory 
